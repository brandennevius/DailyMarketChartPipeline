...
def test_audit_rejects_actionable_candidate_without_verified_chart():
    ...
    packet = build_review_packet(
        ...
        candidates=[
                {
                    "ticker": "AAPL",
                    "origin": "scanner",
                    "origin_categories": ["STANDARD_MARKETSURGE"],
                    ...
                    "average_dollar_volume": 50_000_000,
                        ...
                        "sma50": 95,
                        "sma200": 90,
                    "available_dimensions": ["C_A_fundamentals", "relative_strength", "technical_trend", "supply_demand", "new_or_earnings_context"],
                    "source_evidence": [{"source_type": "STANDARD_MARKETSURGE", "label": "Near Pivot", "pdf_page": 3}],
        ...
        market_data={"market_regime": {"classification": "Confirmed uptrend", "dashboard_market_gauge_posture": "Grow"}},
    )
